            ...
            if (mutation.type === 'childList' && target.className === 'pod') {
                ...
                rows.forEach((row) => {
                    ...
                    if (cell && cell.children.length === 0) {
                        ...
                        let timeRange;
                        const timeInput = document.querySelector('.timePicker input[type=text]').value;
                        try {
                        ...
                        const ep = document.querySelector('div[data-bind="widget: endpointPicker"] .select2-choice span');
                        const np = document.querySelector('div[data-bind="widget: namespacePicker"] .select2-choice span');
                        ...
                        const href = `${url.pathname}?${Array.from(url.searchParams.entries())
